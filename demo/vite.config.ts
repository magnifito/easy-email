...
export default defineConfig({
  ...
  resolve: {
    alias: {
      'easy-email-editor/lib/easy-email-editor.css': path.resolve(__dirname, 'package.json'), // 没有用的，只是防止css 404报错
      'easy-email-extensions/lib/easy-email-extensions.css': path.resolve(__dirname, 'package.json'), // 没有用的，只是防止css 404报错
